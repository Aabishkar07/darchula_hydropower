...
@section('body')
    ...
    <div class="flex items-center">
        <div class="flex-1">
            <h2 class="w-full text-2xl font-bold text-secondary ">Projects</h2>
        </div>
                        ...
                        @foreach ($products as $key => $product)
                            <tbody class="bg-white divide-y divide-gray-200 ">
                                <tr>
                                    ...
                                    <td class="px-5 py-3 ">
                                        <p class="text-gray-900 ">{{ $product->services->title ?? "" }}</p>
                                    </td>
                                    {{-- <td class="px-5 py-3 ">
                                        <p class="text-gray-900 ">{{ $product->category->categoryname ?? '-' }}</p>
                                    </td> --}}

                                    <td class="p-2" style="width: 100px;">
                                        <img class="w-full h-full " src="{{ asset('uploads/' . $product->image) }}"
