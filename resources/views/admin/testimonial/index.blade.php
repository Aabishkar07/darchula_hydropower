...
@section('body')
    ...
    <div class="flex items-center">
        <div class="flex-1">
            <h2 class="w-full text-2xl font-bold text-secondary ">Testimonial</h2>
        </div>
        <div class="text-right "> <a href="{{ route('admin.testimonial.create') }} "
            ...
            <div class="relative mt-10 text-white shadow bg-[#213343] product-tablerounded-lg ">
                <div class="overflow-x-auto ">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        @foreach ($testimonial as $key => $blog)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center p-2">
                                            ...
                                            <form method="POST" action="{{ route('admin.testimonial.destroy', $blog->id) }}"
