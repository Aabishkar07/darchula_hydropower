...
@section('body')
    <div class="flex gap-4">
        ...
        <div class="text-xl font-bold">Edit Popup</div>
    </div>
    <div class="bg-white rounded-lg shadow-md ">
        <form action="{{ route('admin.popup.update', $popup->id) }}" method="POST" class="space-y-6"
            ...
            <div class="p-6 mt-3">
                <div class="flex flex-col ">
                    ...
                    <div class="mt-3">
                        <label class='text-sm font-semibold'>Popup Image</label>
                        ...
                        <img class="oldimage" src="{{ asset('/uploads/' . $popup->image) }}" alt="Card"
