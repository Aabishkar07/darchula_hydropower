...
@section('body')
    ...
    <div class="bg-white rounded-lg shadow-md ">
        <form action="{{ route('admin.banner.update', $banner->id) }}" method="POST" class="space-y-6"
            ...
            <div class="p-6 mt-3">
                <div class="flex flex-col ">
                    ...
                    <div>
                        <button
                            class=" mt-3  px-4 py-1 rounded-md mr-2 text-white bg-[#213343] hover:bg-[#213343] hover:text-white">
                            Edit
                        </button>
                    </div>
                </div>
