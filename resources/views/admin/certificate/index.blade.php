...
@section('body')
    ...
    <div class="flex items-center">
        <div class="flex-1">
            <h2 class="w-full text-2xl font-bold text-secondary">Certificates</h2>
        </div>
        <div class="text-right "> <a href="{{ route('admin.certificate.create') }} "
            ...
            <div class="relative mt-10 text-white shadow bg-[#213343] product-tablerounded-lg ">
                <div class="overflow-x-auto ">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        @foreach ($certificates as $key => $blog)
                            <tbody class="bg-white divide-y divide-gray-200 ">
                                <tr>
                                    ...
                                    {{-- <td class="px-5 py-3 ">
                                        <p class="text-gray-900 ">{{ $blog->blogcategory->categoryname ?? '-' }}</p>
                                    </td> --}}
                                    ...
                                    <td>
                                        <div class="flex items-center p-2">
                                            ...
                                            <a href=" {{ route('admin.certificate.edit', $blog->id) }}">
                                            ...
                                            <form method="POST" action="{{ route('admin.certificate.destroy', $blog->id) }}"
