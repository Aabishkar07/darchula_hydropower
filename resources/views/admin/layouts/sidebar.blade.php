    ...
    <div x-data="handleSwipe()" x-cloak
        ...
        <div>
            <nav class="mt-24">
                ...
                <a class="{{ request()->segment(2) == 'popup' ? ' bg-[#213343]  text-white flex items-center px-6 py-2  mr-3 flex-1 mt-2 item ' : 'mr-3 flex-1 mt-2 item hover:bg-[#213343] hover:text-white flex items-center px-6 py-2  text-gray-600' }}"
                ...
                <a class="{{ request()->segment(2) == 'report' ? ' bg-[#213343]  text-white flex items-center px-6 py-2  mr-3 flex-1 mt-2 item ' : 'mr-3 flex-1 mt-2 item hover:bg-[#213343] hover:text-white flex items-center px-6 py-2  text-gray-600' }}"
