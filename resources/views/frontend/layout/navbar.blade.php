          ...
          <li class='group max-lg:border-b max-lg:py-3 relative'>
            ...
            <ul
              ...
              <li class='border-b py-2 '><a href='{{route("servicesingle",$service->slug)}}'
                class='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'> {{$service->title}}</a></li>
          @endforeach
            </ul>
          </li>
          <li class='group max-lg:border-b max-lg:py-3 relative'>
            ...
            <ul
              ...
              <li class='border-b py-2 '><a href='{{ route('financialreport') }}'
                class='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'>  Financial Reports</a></li>
