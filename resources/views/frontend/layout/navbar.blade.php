...
<header class='flex border-b bg-white font-sans min-h-[70px] tracking-wide relative z-50'>
    <div class='flex flex-wrap items-center justify-between w-full gap-4 px-4 py-3 mx-auto sm:px-10 max-w-screen-2xl'>
      ...
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li class="max-lg:border-b max-lg:py-3">
            <a href="{{ route('home') }}"
               class="{{ request()->routeIs('home') ? 'text-[#007bff] font-bold' : 'text-gray-600 hover:text-[#007bff] text-[15px] font-bold block' }}">
                Home
            </a>
        </li>
            <li class="max-lg:border-b max-lg:py-3">
                <a href="{{ route('about') }}"
                   class="{{ request()->routeIs('about') ? 'text-[#007bff] font-bold' : 'text-gray-600 hover:text-[#007bff] text-[15px] font-bold block' }}">
                    About
                </a>
            </li>
          ...
          <li class='group max-lg:border-b max-lg:py-3 relative'>
            <a href=""              class='hover:text-[#007bff] text-gray-600 text-[15px] font-bold lg:hover:fill-[#007bff] block'>Projects<svg
            ...
            <ul
                ...
                <li class='relative group max-lg:border-b max-lg:py-3'>
                    <a href=""
                        class='hover:text-[#007bff] text-gray-600 text-[15px] font-bold lg:hover:fill-[#007bff] block'>Projects<svg
                    ...
                    <ul
                        ...
                        @foreach ($services as $key => $service)
                            <li class='py-2 border-b '><a href='{{ route('servicesingle', $service->slug) }}'
                ...
                <li class='relative group max-lg:border-b max-lg:py-3'>
                    <a href=""
                        class='hover:text-[#007bff] text-gray-600 text-[15px] font-bold lg:hover:fill-[#007bff] block'>Reports<svg
                            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" class="inline-block ml-1"
                            viewBox="0 0 24 24">
                            <path
                                d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
                    ...
                    <ul
                        class='absolute shadow-lg bg-white space-y-3 lg:top-5 max-lg:top-8 -left-6 min-w-[250px] z-50 max-h-0 overflow-hidden group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500'>
                        <li class='py-2 border-b '><a href='{{ route('financialreport') }}'
                                class='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'> Financial
                                Reports</a></li>
                        <li class='py-2 border-b '>
                            <a href='{{ route('newsandnotice') }}'
                                class='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'> News & Notice
                            </a>
                        </li>
                ...
                <li class="max-lg:border-b max-lg:py-3">
                    <a href="{{ route('allgallery') }}"
                        class="{{ request()->routeIs('allgallery') ? 'text-[#007bff] font-bold' : 'text-gray-600 hover:text-[#007bff] text-[15px] font-bold block' }}">
                        Gallery
                    </a>
                </li>
                ...
                <li class="max-lg:border-b max-lg:py-3">
                    <a href="{{ route('allblogs') }}"
                        class="{{ request()->routeIs('allblogs') ? 'text-[#007bff] font-bold' : 'text-gray-600 hover:text-[#007bff] text-[15px] font-bold block' }}">
                        Blogs
                    </a>
                </li>
                ...
                <li class="max-lg:border-b max-lg:py-3">
                    <a href="{{ route('videos') }}"
                        class="{{ request()->routeIs('videos') ? 'text-[#007bff] font-bold' : 'text-gray-600 hover:text-[#007bff] text-[15px] font-bold block' }}">
                        Video
                    </a>
                </li>
                ...
                <li class="max-lg:border-b max-lg:py-3">
                    <a href="{{ route('contact') }}"
                        class="{{ request()->routeIs('contact') ? 'text-[#007bff] font-bold' : 'text-gray-600 hover:text-[#007bff] text-[15px] font-bold block' }}">
                        Contact
                    </a>
                </li>
